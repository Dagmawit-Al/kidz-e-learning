...
function SignUpForm({
  ...
  const handleLoginWithUsernameAndPassword = (e) => {
    loginWithUsernameAndPassword(e, email, password);
  };
  ...
  const handleSignUpWithUsernameAndPassword = (e) => {
    const data = {
      firstname: firstname,
      lastname: lastname,
      email: email,
    ...
    signupWithUsernameAndPassword(e, email, password, data);
  };
          ...
          <CardBody className="flex flex-col gap-4">
            ...
            >
              ...
              <TERipple rippleColor="light" className="w-full flex">
                ...
                <Button
                  className="text-black bg-[#FB9060]"
                  onClick={handleClose}
                >
                  Close
                </Button>
