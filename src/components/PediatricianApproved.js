  ...
  return (
    <figure class="max-w-screen-md mx-auto text-center p-8 space-y-8">
      ...
      <div class="flex justify-center">
        <img class="border-solid border-4 border-green-100 w-50 h-50 rounded-full" src={pediatrician} alt="" />
      </div>
      <blockquote>
      ...
      <div class="inline-flex items-center justify-center w-full">
        ...
        <div class="absolute px-4 -translate-x-1/2 bg-[#faf8f0] left-1/2 dark:bg-gray-900">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="fuchsia" className="w-12 h-12">
