        ...
        <div className="flex justify-between w-full px-4 sm:px-0">
          <article className="mx-auto w-full p-5 md:w-[75%] p-10 md:p-20 format format-sm sm:format-base lg:format-lg format-blue dark:format-invert bg-white shadow-2xl rounded-lg">
            ...
            <div className="space-y-10 text-lg">
              ...
              <h2 className="comic-sans-medium text-gray-700 text-start md:text-center leading-tight md:leading-normal">1. Nurturing Creativity and Innovation</h2>
              ...
              <h2 className="comic-sans-medium text-gray-700 text-start md:text-center leading-tight md:leading-normal">2. Developing Entrepreneurial Skills</h2>
              <p class="roboto-medium text-xl lead text-gray-700 text-center">
              ...
              <h2 className="comic-sans-medium text-gray-700 text-start md:text-center leading-tight md:leading-normal">3. Fostering Financial Literacy</h2>
              <p class="roboto-medium text-xl lead text-gray-700 text-center">
              ...
              <h2 className="comic-sans-medium text-gray-700 text-start md:text-center leading-tight md:leading-normal">4. Preparing for the Future Economy</h2>
              <p class="roboto-medium text-xl lead text-gray-700 text-center">
              ...
              <h2 className="comic-sans-medium text-gray-700 text-start md:text-center leading-tight md:leading-normal">5. Empowering Youth</h2>
              <p class="roboto-medium text-xl lead text-gray-700 text-center">
