...
const FullBlog = () => {
    return (
        <>
            ...
            <main class="container relative flex flex-col justify-start items-center mx-auto space-y-10 mt-10 px-8 py-10 lg:py-28 antialiased">
                        ...
                        <header class="mb-4 lg:mb-6 not-format">
                            <address class="flex items-center mb-6 not-italic">
                                <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">Filagot Tesfaye</a>
                                        <p class="text-base text-gray-500 dark:text-gray-400">Graphic Designer, educator & CEO Flowbite</p>
                                        <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Apr. 8, 2024</time></p>
                                    </div>
                                </div>
                            </address>
                            <h1 class="mystery-quest-header mb-4 font-extrabold leading-tight text-gray-900 dark:text-white">Business Plans: A Step-by-Step Guide for Kid Entrepreneurs</h1>
                        </header>
                        <figure><img src="https://flowbite.s3.amazonaws.com/typography-plugin/typography-image-1.png" alt="" />
                        </figure>
                        <div className="space-y-8 p-5 text-lg w-full">
